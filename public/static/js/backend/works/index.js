...
var tableOptions = {
  ...
  cols: [[
      ...
      { field: 'avgscore', title: "平均分",align:'center', width:70,templet:function (d) {return d.avgscore? Math.round(d.avgscore*100)/100:'暂无评分'; }},
      { field: 'set_score', title: "暂未设定",align:'center', edit: 'text', width:70,templet:function (d) {return d.set_score?d.set_score:'暂未设定'; }},
      { title: "操作", fixed:'right',width:g_AdminRoleCode==='specialist'?140:395,align:'center', templet: '#action' },
  ]],
  done: function (res) {
...
$('#btnExportGrade').click(function (e) {
  var exportFields = ['workcode', 'title', 'declaration_group', 'works_category', 'city','name', 'completion_date', 'contestants', 'creator_designer','creator_idcard','age','creator_tel','creator_email','contact_person','contact_tel','contact_email','expert1','expert2','expert3','expert4','expert5','expert6','expert7','grade_chusai_avg','check1_remark','team_member'];
  var rowHeader = {
    workcode:'申报编号',
    title:'作品名称',
